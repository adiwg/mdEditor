    ...
    if (model) {
      once(this, function () {
        set(
          model,
          'attributeGroup',
          get(model, 'attributeGroup') !== undefined
            ? get(model, 'attributeGroup')
            : [],
        );
        set(
          model,
          'imageDescription',
          get(model, 'imageDescription') !== undefined
            ? get(model, 'imageDescription')
            : {},
        );
        set(
          model,
          'processingLevelCode',
          get(model, 'processingLevelCode') !== undefined
            ? get(model, 'processingLevelCode')
            : {},
        );
      });
    }
