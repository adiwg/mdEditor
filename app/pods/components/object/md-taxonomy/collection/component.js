  ...
  didReceiveAttrs() {
    ...
    once(this, function () {
      set(
        model,
        'taxonomicClassification',
        get(model, 'taxonomicClassification') !== undefined
      ...
      set(
        model,
        'taxonomicSystem',
        get(model, 'taxonomicSystem') !== undefined
          ? get(model, 'taxonomicSystem')
          : [],
      );
      set(
        model,
        'identificationReference',
        get(model, 'identificationReference') !== undefined
      ...
      set(
        model,
        'observer',
        get(model, 'observer') !== undefined ? get(model, 'observer') : [],
      );
      set(
        model,
        'voucher',
        get(model, 'voucher') !== undefined ? get(model, 'voucher') : [],
      );
    });
  },
