  ...
  didReceiveAttrs() {
    ...
    once(this, function () {
      ...
      set(
        model,
        'sourceCitation',
        get(model, 'sourceCitation') !== undefined
          ? get(model, 'sourceCitation')
          : {},
      );
      set(
        model,
      ...
      set(
        model,
        'referenceSystem',
        get(model, 'referenceSystem') !== undefined
          ? get(model, 'referenceSystem')
          : {},
      );
      set(
        model,
        'referenceSystem.referenceSystemIdentifier',
        get(model, 'referenceSystem.referenceSystemIdentifier') !== undefined
          ? get(model, 'referenceSystem.referenceSystemIdentifier')
          : {},
      );
      set(
        model,
        'sourceProcessStep',
        get(model, 'sourceProcessStep') !== undefined
          ? get(model, 'sourceProcessStep')
          : [],
      );
      set(
        model,
