...
export default Route.extend(ScrollTo, {
  ...
  getTitle(record) {
    ...
    switch (record.type) {
      case 'records':
        return get(json, 'metadata.resourceInfo.citation.title') !== undefined
          ? get(json, 'metadata.resourceInfo.citation.title')
          : 'NO TITLE';
      case 'dictionaries':
        return get(json, 'dataDictionary.citation.title') !== undefined
