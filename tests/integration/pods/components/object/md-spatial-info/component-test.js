...
module('Integration | Component | object/md spatial info', function(hooks) {
  ...
  test('it renders', async function(assert) {
    ...
    assert.equal(this.element.textContent.replace(/[\s\n]+/g, '|').trim(),
      '|Spatial|Representation|Type|×|stereoModel|?|three-dimensional|view|formed|by|the|intersecting|homologous|rays|of|an|overlapping|pair|of|images|×|vector|?|vector|data|is|used|to|represent|geographic|data|Spatial|Reference|System|5|Add|OK|#|Reference|System|Type|Identifier|0|referenceSystemType|identifier|Edit|Delete|1|projected|Zone|10|Edit|Delete|2|geodeticGeographic2D|4326|Edit|Delete|3|projected|Not|Defined|Edit|Delete|4|geodeticGeographic2D|Not|Defined|Edit|Delete|OK|Spatial|Resolution|6|Add|OK|#|Scale|Factor|Level|Of|Detail|Type|0|99999|Not|Defined|Not|Defined|Edit|Delete|1|Not|Defined|Not|Defined|distance|Edit|Delete|2|Not|Defined|levelOfDetail|Not|Defined|Edit|Delete|3|Not|Defined|Not|Defined|Not|Defined|Edit|Delete|4|Not|Defined|Not|Defined|Not|Defined|Edit|Delete|5|Not|Defined|Not|Defined|Not|Defined|Edit|Delete|OK|Add|Spatial|Resolution|');
    ...
    assert.equal(this.element.textContent.replace(/[\s\n]+/g, '|').trim(),
      '|Spatial|Representation|Type|Spatial|Reference|System|0|Add|OK|#|Reference|System|Type|Identifier|Add|Reference|System|OK|Spatial|Resolution|0|Add|OK|#|Scale|Factor|Level|Of|Detail|Type|Add|Spatial|Resolution|OK|template|block|text|',
      'block');
  });
