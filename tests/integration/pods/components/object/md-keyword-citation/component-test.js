...
module(
  'Integration | Component | object/md keyword citation',
  function (hooks) {
    ...
    test('it renders', async function (assert) {
      ...
      await render(
        hbs`{{object/md-keyword-citation model=keyword profilePath="foobar"}}`
      );
      ...
      assert.equal(
        input,
        'title0|2016-10-13|edition|http://adiwg.org',
        'input values'
      );
