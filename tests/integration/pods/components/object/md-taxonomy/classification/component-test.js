...
module(
  'Integration | Component | object/md taxonomy/classification',
  function (hooks) {
    ...
    test('it renders', async function (assert) {
      ...
      await render(
        hbs`{{object/md-taxonomy/classification model=model profilePath="foobar"}}`
      );
      ...
      await render(
        hbs`{{object/md-taxonomy/classification model=model preview=true profilePath="foobar"}}`
      );
