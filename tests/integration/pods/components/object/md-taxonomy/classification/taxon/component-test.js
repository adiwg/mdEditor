...
module(
  'Integration | Component | object/md taxonomy/classification/taxon',
  function (hooks) {
    ...
    test('it renders', async function (assert) {
      ...
      await render(
        hbs`{{object/md-taxonomy/classification/taxon model=model deleteTaxa=delete top=top profilePath="foobar"}}`
      );
