...
module(
  'Integration | Component | object/md taxonomy/collection/system',
  function (hooks) {
    ...
    test('it renders', async function (assert) {
      ...
      await render(
        hbs`{{object/md-taxonomy/collection/system model=model profilePath="foobar"}}`
      );
      ...
      assert.equal(
        input,
        'modifications|Integrated Taxonomic Information System (ITIS)|2019-02-26|Taxa imported from ITIS||||||Retrieved from the Integrated Taxonomic Information System on-line database, https://www.itis.gov.',
        'input values'
      );
