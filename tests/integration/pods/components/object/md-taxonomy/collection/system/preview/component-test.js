...
module(
  'Integration | Component | object/md taxonomy/collection/system/preview',
  function (hooks) {
    ...
    test('it renders', async function (assert) {
      ...
      await render(
        hbs`{{object/md-taxonomy/collection/system/preview model=model profilePath="foobar"}}`
      );
      ...
      assert.equal(
        input,
        'Integrated Taxonomic Information System (ITIS)|modifications',
        'input values'
      );
