...
module(
  'Integration | Component | object/md taxonomy/collection',
  function (hooks) {
    ...
    test('it renders', async function (assert) {
      ...
      assert.equal(
        input,
        'Integrated Taxonomic Information System (ITIS)|modifications||Scope|Id Procedure|Id Completeness',
        'input values'
      );
    ...
    `);
      ...
      assert.equal(
        this.element.textContent.replace(/[\s\n]+/g, '|').trim(),
        '|No|Taxonomic|System|found.|Add|Taxonomic|System|Classification|No|Classification|found.|No|Observer|found.|Add|Observer|General|Scope|Identification|Procedure|Identification|Completeness|No|Voucher|found.|Add|Voucher|',
        'block'
      );
    });
  }
