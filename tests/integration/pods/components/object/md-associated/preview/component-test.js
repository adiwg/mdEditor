...
module(
  'Integration | Component | object/md associated/preview',
  function (hooks) {
    ...
    test('it renders', async function (assert) {
          ...
          identifier: [
            {
              ...
              description:
                'Identifier imported from ScienceBase during publication',
            },
          ],
        },
        metadataCitation: {
      ...
      await render(
        hbs`{{object/md-associated/preview item=model class="testme"}}`
      );
