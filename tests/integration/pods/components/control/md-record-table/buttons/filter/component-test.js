...
module(
  'Integration | Component | control/md record table/buttons/filter',
  function (hooks) {
    ...
    test('it renders', async function (assert) {
      ...
      await render(
        hbs`{{control/md-record-table/buttons/filter deleteSelected=deleteSelected selectedItems=selectedItems}}`
      );

      assert.equal(
        find('button.btn-danger').textContent.trim(),
        'Delete Selected'
      );
