...
export default EmberObject.extend({
  ...
  uuid: computed.alias('id')
    .readOnly(),
  identifier: computed.alias('id')
    .readOnly(),
  ...
  nodeClass: computed('sortOrder', function () {
    return this.get('sortOrder') ? 'tree-node-unrooted' :
      'tree-node-rooted';
  }),
      ...
      .then(function (response) {
        ...
        if(response.id) {
          ...
          if(idObj) {
            ...
            set(idObj, 'authority', getWithDefault(idObj, 'authority', {
              date: [],
              title: 'ScienceBase'
            }));
            set(idObj, 'authority.title', getWithDefault(idObj,
              'authority.title', 'ScienceBase'));
            set(idObj, 'authority.date', getWithDefault(idObj,
              'authority.date', []));
