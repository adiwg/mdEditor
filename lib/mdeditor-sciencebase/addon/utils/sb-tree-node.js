...
export default EmberObject.extend({
  ...
  sbParentIdObj: computed('sbParentId', function() {
    ...
    return get(record, path).findBy('namespace',
      'gov.sciencebase.catalog');
  }),

  sbDate: computed('sbParentId', function() {
    let dates = this.get('sbParentIdObj.authority.date');
    ...
    if(dates) {
      ...
      return published.reduce(function(a, b) {
        return moment.max(moment(a.date), moment(b.date));
      });
    }
