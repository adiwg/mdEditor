...
export default Component.extend({
  ...
  init() {
    ...
    console.log("sb-publisher init config", config);
    console.log("keycloak is initialized", this.keycloak.isInitialized);
  ...
  actions: {
    ...
    login() {
      console.log("sb-publisher login");
