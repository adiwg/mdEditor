...
export default LeafletMap.extend({
  ...
  '_draw:editstart': function(e) {
    ...
    layers.forEach((layer) => {
      if (Object.prototype.hasOwnProperty.call(layer, 'editing')) {
        if (layer.feature.state !== 'edit') {
