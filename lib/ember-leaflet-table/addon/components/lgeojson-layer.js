...
export default Layer.extend({
  ...
  formVisible: on(
    "init",
    observer("geoJSON.form", function () {
      ...
      if (form) {
        ...
        if (
          drawControl &&
          drawControl.options.edit.featureGroup === layerGroup
        ) {
